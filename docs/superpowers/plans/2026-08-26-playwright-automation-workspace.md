...
Migration note: use `2026-08-29-playwright-runner-deploy-readiness.md` as the active delivery sequence. Keep legacy and Playwright APIs separate during rollout; the older proposal to combine both payloads under `/api/test-runner/jobs` is superseded.
